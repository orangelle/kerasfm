...
class TFFMClassifier(TFFMBaseModel):
    ...
    def fit(self, X, y, sample_weight=None, pos_class_weight=None, n_epochs=None, show_progress=False, graph_mode=True):
    ...
    def predict(self, X, pred_batch_size=None, graph_mode=False):
        ...
        """
        raw_output = self.decision_function(X, pred_batch_size, graph_mode)
